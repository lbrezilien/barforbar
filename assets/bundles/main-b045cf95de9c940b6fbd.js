...
/***/ function(module, exports) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  ...
	  render: function () {
	    var comp = this;
	    return React.createElement("div", { className: "row" }, React.createElement("h2", null, " ", this.props.params.name, " Songs: "), React.createElement("ul", null, comp.state.songs.map(function (song) {
	      return React.createElement("li", { key: song.pk }, "Song Title: ", song.title, ", Artist: ", song.artist);
	    })), React.createElement("table", { className: "highlight" }, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", { "data-field": "id" }, "Title"), React.createElement("th", { "data-field": "name" }, "Artist "))), React.createElement("tbody", null, React.createElement("tr", null, React.createElement("td", null, "Alvin"), React.createElement("td", null, "Eclair"), React.createElement("td", null, "$0.87")))));
	  }
	});
