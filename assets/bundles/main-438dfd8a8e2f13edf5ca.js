...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	    ...
	    render: function () {
	        var comp = this;
	        return React.createElement("div", { className: "row" }, comp.state.songs.map(function (song) {
	            return React.createElement("li", null, "song.title"), React.createElement("li", null, " song.artist ");
	        }));
	    }
	});
