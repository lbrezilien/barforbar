...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Router, null, React.createElement(Route, { component: App }, React.createElement(Route, { path: "/", component: Browseflow }), React.createElement(Route, { path: "mood/:name", component: SongList }), React.createElement(Route, { path: "genre/:name", component: SongList }))), document.getElementById('react-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  ...
	  render: function () {
	    return React.createElement("div", { className: "row" }, React.createElement("div", { className: "row" }, React.createElement("h2", null, " Browse by Mood: "), React.createElement("hr", null)), React.createElement("div", { className: "row" }, this.state.moods.map(function (result) {
	      return React.createElement(Card, { key: result.pk, category: result, url: "mood/" });
	    }), React.createElement("hr", null)), React.createElement("div", { className: "row" }, React.createElement("h2", null, " Browse by Genre: "), React.createElement("hr", null)), React.createElement("div", { className: "row" }, this.state.genres.map(function (result) {
	      return React.createElement(Card, { key: result.pk, category: result, url: "genre/" });
