...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	   render: function () {
	      return React.createElement("div", { className: "col m3" }, React.createElement("div", { className: "card" }, React.createElement("div", { className: "card-image discover" }, React.createElement("img", { src: "/static/img/" + "happy.jpeg" }), React.createElement("span", { className: "icon" }, React.createElement("i", { className: "fa fa-smile-o fa-5x" }))), React.createElement("div", { className: "card-action" }, React.createElement(Link, { to: "mood/" + this.props.mood.title }, React.createElement("span", { className: "card-title flow-text" }, this.props.mood.title)))));
	   }
	});
