...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Router, null, React.createElement(Route, { component: App }, React.createElement(Route, { path: "/", component: Browseflow }), React.createElement(Route, { path: "moods/:name", component: SongList }), React.createElement(Route, { path: "genres/:name", component: SongList }))), document.getElementById('react-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	    ...
	    componentDidMount: function () {
	        var component = this;
	        $.get("http://localhost:8000/lyrics/" + component.props.params.apiRoute, function (data) {
