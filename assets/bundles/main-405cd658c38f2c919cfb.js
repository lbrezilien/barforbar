...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  ...
	  //  componentDidMount: function(){
	  //       var component = this;
	  //       $.get("http://localhost:8000/lyrics/moods", function(data1){
	  //         component.setState({data: data});
	  //       });
	  //   },
	  render: function () {
	    var arr = [{ id: '1', title: 'jfjkd', soe: [2, 3] }, { id: '2', title: 'bow', soe: [3, 2] }];
	    var component = this;
	    $.get("http://localhost:8000/lyrics/moods", function (data1) {
	      component.setState({ data: data1 });
	    });

	    return React.createElement("div", { className: "row", arr: arr }, React.createElement("div", null, this.state.data.map(function (result) {
	      return React.createElement("li", { key: result.pk }, result.fields.title, " ", result.fields.lyrics);
	    }), this.state.title));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  render: function () {
	    return React.createElement("div", null, React.createElement("h1", null, "Hello, world."), React.createElement("p", null, "these are my cards: "));
	  }
	});
