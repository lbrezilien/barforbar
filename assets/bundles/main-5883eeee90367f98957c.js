...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  ...
	  render: function () {
	    ...
	    }), React.createElement("hr", null)), React.createElement("div", { className: "row" }, React.createElement("h2", null, " Browse by Genre: "), React.createElement("hr", null)), React.createElement("div", { className: "row" }, this.state.moods.map(function (result) {
	      return React.createElement(Card, { key: result.pk, mood: result });
