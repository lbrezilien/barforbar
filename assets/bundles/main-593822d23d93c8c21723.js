	...
	module.exports = React.createClass({ displayName: "exports",
	  ...
	  render: function () {
	    ...
	    $.get("http://localhost:8000/lyrics/moods", function (data1) {
	      ...
	      debugger;
	      component.setState({ data: component.state.data.concat(data1) });
	      debugger;
	    });

	    return React.createElement("div", { className: "row", arr: arr }, React.createElement("div", null, this.state.data));
	  }
	});
