...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  render: function () {
	    return React.createElement("div", { className: "col m3" }, React.createElement("div", { className: "card" }, React.createElement("div", { className: "card-image" }, React.createElement("img", { src: "images/sample-1.jpg" }, " ")), React.createElement("div", { className: "card-content" }), React.createElement("div", { className: "card-action" }, React.createElement(Link, { to: "mood/" + this.props.mood.title }, React.createElement("span", { className: "card-title flow-text" }, this.props.mood.title)))));
	  }
	});
