...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	   ...
	   render: function () {
	      var arr = [];
	      var data = $.get("http://localhost:8000/lyrics/moods");
	      for (var i = 0; i < 2; i++) {
	         arr.push(React.createElement("h1", null, " data[i].title "));
	      }
	      return React.createElement("div", { className: "row" }, React.createElement("div", null, arr));
	   }
	});
