...
/***/ function(module, exports, __webpack_require__) {
	...
	var Browseflow = __webpack_require__(219);
	...
	ReactDOM.render(React.createElement(Router, null, React.createElement(Route, { component: App }, React.createElement(Route, { path: "/", component: Browseflow }), React.createElement(Route, { path: "/list", component: SongList }))), document.getElementById('react-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  render: function () {
	    return React.createElement("div", { className: "row" }, React.createElement("div", { className: "row" }, React.createElement("h2", null, " Browse by Mood: "), React.createElement("hr", null)), React.createElement("div", { className: "row" }, this.props.flowState.data.map(function (result) {
	      return React.createElement(Card, { key: result.pk, mood: result.fields });
	    }), React.createElement("hr", null)), React.createElement("div", { className: "row" }, React.createElement("h2", null, " Browse by Genre: "), React.createElement("hr", null)), React.createElement("div", { className: "row" }, this.props.flowState.data.map(function (result) {
	      return React.createElement(Card, { key: result.pk, mood: result.fields });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  render: function () {
	    return React.createElement("div", { className: "col m2 card blue-grey darken-1", style: { marginRight: '10%' } }, React.createElement("div", { className: "card-content white-text" }, React.createElement("span", { className: "card-title flow-text" }, this.props.mood.title)));
	  }
	});
