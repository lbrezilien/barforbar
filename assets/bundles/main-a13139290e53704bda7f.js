...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  render: function () {
	    return React.createElement("div", { className: "col m2 card blue-grey darken-1", style: { marginRight: '10%' } }, React.createElement("div", { class: "card" }, React.createElement("div", { class: "card-image" }, React.createElement("img", { src: "images/sample-1.jpg" }, " "), React.createElement("span", { class: "card-title" }, "Card Title")), React.createElement("div", { class: "card-content" }, React.createElement("p", null, "I am a very simple card. I am good at containing small bits of information." + ' ' + "I am convenient because I require little markup to use effectively.")), React.createElement("div", { class: "card-action" }, React.createElement("a", { href: "#" }, "This is a link"))));
	  }
	});
