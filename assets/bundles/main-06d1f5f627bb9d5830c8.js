...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  ...
	  render: function () {
	    var arr = [React.createElement("h1", null, "jfkjdf"), React.createElement("h2", null, "yudyugus")];
	    var component = this;
	    $.get("http://localhost:8000/lyrics/moods", function (data1) {
	      component.setState(data1[0]);
	    });

	    return React.createElement("div", { className: "row", arr: arr }, React.createElement("div", null, arr, this.state.title));
	  }
	});
