...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  ...
	  render: function () {
	    ...
	    return React.createElement("div", { className: "row" }, React.createElement(Router, { history: browserHistory }, React.createElement(Route, { path: "/", component: Browseflow }), React.createElement(Route, { path: "list", component: Songlist })));
	  }
	});
