...
/***/ function(module, exports, __webpack_require__) {
	...
	var Browseflow = __webpack_require__(147);
	var App = __webpack_require__(218);
	var Router = __webpack_require__(149).Router;
	var Route = __webpack_require__(149).Route;
	var Link = __webpack_require__(149).Link;
	var SongList = __webpack_require__(219);
	var React = __webpack_require__(171);

	ReactDOM.render(React.createElement(Router, null, React.createElement(Route, { component: App }, React.createElement(Route, { path: "/", component: Browseflow }), React.createElement(Route, { path: "mood/:name", component: SongList }))), document.getElementById('react-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  ...
	  componentDidMount: function () {
	    var component = this;
	    $.get("http://localhost:8000/lyrics/moods", function (moods) {
	      component.setState({ data: moods });
	    });

	    $.get("http://localhost:8000/lyrics/genres", function (genres) {
	      component.setState({ data: component.state.data, data2: genres });
	    });
	  },
	  render: function () {
	    return React.createElement("div", { className: "row" }, React.createElement("div", { className: "row" }, React.createElement("h2", null, " Browse by Mood: "), React.createElement("hr", null)), React.createElement("div", { className: "row" }, this.state.data.map(function (result) {
	      return React.createElement(Card, { key: result.pk, mood: result });
	    }), React.createElement("hr", null)), React.createElement("div", { className: "row" }, React.createElement("h2", null, " Browse by Genre: "), React.createElement("hr", null)), React.createElement("div", { className: "row" }, this.state.data2.map(function (result) {
	      return React.createElement(Card, { key: result.pk, genre: result });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  ...
	  render: function () {
	    return React.createElement("div", { className: "col m3" }, React.createElement("div", { className: "card" }, React.createElement("div", { className: "card-image discover" }, React.createElement("img", { src: "/static/img/" + "happy.jpeg" }), React.createElement("div", { className: "icon" }, React.createElement("i", { className: "fa fa-5x fa-" + this.moodGenreDict["" + this.props.mood.title + ""] }))), React.createElement("div", { className: "card-action center-text" }, React.createElement(Link, { to: "mood/" + this.props.mood.title }, React.createElement("span", { className: "bold" }, this.props.mood.title)))));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibUseQueries = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PathUtils = __webpack_require__(155);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deprecate = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	    ...
	    componentDidMount: function () {
	        ...
	        $.get("http://localhost:8000/lyrics/moods", function (data) {
	            var songs = data.filter(function (object) {
	                if (object.title == component.props.params.name) {
	                    return object;
	                }
	            });
	    ...
	    render: function () {
	        var comp = this;
	        return React.createElement("div", { className: "row card form-padding" }, React.createElement("h2", null, " ", this.props.params.name, " Songs: "), React.createElement("ul", null), React.createElement("table", { className: "highlight " }, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", { "data-field": "SongTitle" }, "Song Title"), React.createElement("th", { "data-field": "Artist" }, "Artist "), React.createElement("th", { "data-field": "Lyrics" }, "Lyrics "))), React.createElement("tbody", null, comp.state.songs.map(function (song) {
	            return React.createElement("tr", { key: song.pk }, React.createElement("td", null, song.title), React.createElement("td", null, song.artist), React.createElement("td", null, React.createElement("a", { href: "/lyrics/" + song.pk }, React.createElement("i", { className: "material-icons" }, "description"))));
	        }))));
	    }
	});
