...
/***/ function(module, exports) {
	...
	module.exports = React.createClass({ displayName: "exports",
	    ...
	    render: function () {
	        ...
	        return React.createElement("div", { className: "row" }, React.createElement("h1", null, this.state.songs.map(function (song) {
	            React.createElement("h1", null, "song.title, song.artist");
	        })));
	    }
	});
