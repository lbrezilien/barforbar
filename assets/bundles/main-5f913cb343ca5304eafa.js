...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	  ...
	  render: function () {
	    ...
	    return React.createElement("div", { className: "row" }, React.createElement(Router, null, React.createElement(Route, { path: "/", component: Browseflow, flowState: this.state }), React.createElement(Route, { path: "list", component: Songlist })));
	  }
	});
